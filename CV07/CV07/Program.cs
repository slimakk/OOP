...
namespace CV07
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            string[] cisla2 = new string[] { "jeden", "dva", "trinast", "xdesiatosem" };
            ...
            Console.WriteLine("Najvacsia: {0}", Extremy.Najvacsia(cisla));
            Console.WriteLine("Najmensia: {0}", Extremy.Najmensia(cisla));

            Console.WriteLine("Najvacsia: {0}", Extremy.Najvacsia(cisla2));
            Console.WriteLine("Najmensia: {0}", Extremy.Najmensia(cisla2));
